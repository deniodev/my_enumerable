...
**[My Enumerable]** implements the following methods:
...
- cd `my_enumerable`
- `git clone git@github.com:deniodev/my_enumerable.git`
...
Feel free to check the [issues page](https://github.com/deniodev/my_enumerable/issues).
